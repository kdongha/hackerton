...
public class Data {
	String date;
	String road_name; // ?èÑÎ°?
	String road_start; // ?ãú?†ê
	String road_end; // Ï¢ÖÏ†ê
	double length; // Í∏∏Ïù¥ 
	int road_cnt; // Ï∞®ÏÑ†?†ïÎ≥?
	long flow_table[]; // ?ãúÍ∞ÑÎ≥Ñ ?ú†?üâ flow
	double speed_table[];// ?ãúÍ∞ÑÎ≥Ñ ?èâÍ∑? ?Üç?èÑ speed
